-- Seleciona o mês e ano do pedido, a soma do ValorLiquido por mês/ano, ordenados por data crescente
SELECT
    TO_CHAR(l.DataPedido, 'YYYY-MM') AS MesAno, -- Extrai o mês e ano da coluna DataPedido
    SUM(pv.ValorLiquido) AS ValorTotalLiquido -- Soma os valores de ValorLiquido para cada mês/ano
FROM
