-- Seleciona a soma da coluna Quantidade para cada clienteID por meio da tabela logistica
...
SELECT
    ...
    c.Cidade, -- Seleciona a cidade da tabela clientes
    c.Pais, -- Seleciona o País da tabela clientes
    c.Regiao, -- Seleciona a Região da tabela clientes
...
GROUP BY
    c.ClienteID, c.Cliente, c.Cidade, c.Pais, c.Regiao -- Agrupa os resultados pelo ClienteID, Cliente, Cidade, País e Região
ORDER BY
